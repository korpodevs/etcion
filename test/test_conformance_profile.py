...
Covers four stories:
  ...
  STORY-01.1.2 — All 16 fields: 1 spec_version, 12 shall-level, 2 should-level,
                  1 may-level
  STORY-01.1.3 — Re-exports from etcion.__init__ and SPEC_VERSION consistency
...
CONFORMANCE_MODULE = REPO_ROOT / "src" / "etcion" / "conformance.py"
...
class TestConformanceModuleExists:
    def test_conformance_py_exists(self) -> None:
        assert CONFORMANCE_MODULE.exists(), "src/etcion/conformance.py must exist"


class TestConformanceImport:
    def test_import_from_conformance_module(self) -> None:
        from etcion.conformance import CONFORMANCE, ConformanceProfile  # noqa: PLC0415
    ...
    def test_conformance_profile_is_frozen_dataclass(self) -> None:
        from etcion.conformance import CONFORMANCE  # noqa: PLC0415
...
class TestConformanceProfileFieldCount:
    def test_has_exactly_16_fields(self) -> None:
        from etcion.conformance import ConformanceProfile  # noqa: PLC0415
...
class TestInitReexports:
    def test_import_conformance_profile_from_etcion(self) -> None:
        from etcion import ConformanceProfile  # noqa: PLC0415

        assert ConformanceProfile is not None

    def test_import_conformance_singleton_from_etcion(self) -> None:
        from etcion import CONFORMANCE  # noqa: PLC0415
    ...
    def test_conformance_profile_in_all(self) -> None:
        ...
        assert "ConformanceProfile" in etcion.__all__

    def test_conformance_singleton_in_all(self) -> None:
        import etcion  # noqa: PLC0415

        assert "CONFORMANCE" in etcion.__all__
    ...
    def test_spec_version_value_is_3_2(self) -> None:
        ...
        assert etcion.CONFORMANCE.spec_version == "3.2"
