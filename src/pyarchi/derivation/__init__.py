"""pyarchi.derivation -- Relationship derivation engine.
...
Import policy
-------------
This package MAY import from pyarchi.metamodel, pyarchi.enums, and
pyarchi.validation.  It is the top of the internal dependency graph.
"""
