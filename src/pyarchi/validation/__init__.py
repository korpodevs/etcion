"""pyarchi.validation -- Metamodel constraint and permission checking.
...
Import policy
-------------
This package MAY import from pyarchi.metamodel and pyarchi.enums.
It must NOT import from pyarchi.derivation.
"""
